      ...
      <div className="container mx-auto relative z-10">
        ...
        <Tabs defaultValue="all" className="w-full mt-8">
          <TabsList className="grid w-full grid-cols-4 bg-zinc-900 border border-zinc-800">
            <TabsTrigger 
              value="all" 
              className="data-[state=active]:bg-frezza-red data-[state=active]:text-white text-gray-400 hover:text-white transition-all"
            >
              Todos
            </TabsTrigger>
            <TabsTrigger 
          ...
          <TabsContent value="all" className="mt-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              <div className="glass-card p-6 text-center rounded-xl hover:scale-105 transition-transform duration-300">
                <div className="text-3xl md:text-4xl font-bold text-frezza-red mb-2">+500%</div>
                <div className="text-gray-300 text-sm">ROI Médio</div>
              </div>
              <div className="glass-card p-6 text-center rounded-xl hover:scale-105 transition-transform duration-300">
                <div className="text-3xl md:text-4xl font-bold text-frezza-red mb-2">2M+</div>
                <div className="text-gray-300 text-sm">Impressões</div>
              </div>
              <div className="glass-card p-6 text-center rounded-xl hover:scale-105 transition-transform duration-300">
                <div className="text-3xl md:text-4xl font-bold text-frezza-red mb-2">150+</div>
                <div className="text-gray-300 text-sm">Clientes</div>
              </div>
              <div className="glass-card p-6 text-center rounded-xl hover:scale-105 transition-transform duration-300">
                <div className="text-3xl md:text-4xl font-bold text-frezza-red mb-2">98%</div>
            ...
            <div className="mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-center mb-8 text-white">Casos de Sucesso</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="group overflow-hidden border-white/10 bg-gradient-to-br from-zinc-900/50 to-black hover:from-frezza-red/10 hover:to-zinc-900/50 transition-all duration-500 hover:scale-105">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <ChartBarIncreasing className="text-frezza-red mr-3" size={24} />
                      <span className="text-frezza-red font-semibold">E-commerce</span>
                    </div>
                    <h4 className="text-xl font-bold mb-2 text-white">Loja de Moda</h4>
                    <p className="text-gray-400 mb-4 text-sm">Aumento de 340% nas vendas online em apenas 3 meses.</p>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-300">ROI:</span>
                      <span className="text-frezza-red font-bold">+340%</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="group overflow-hidden border-white/10 bg-gradient-to-br from-zinc-900/50 to-black hover:from-frezza-red/10 hover:to-zinc-900/50 transition-all duration-500 hover:scale-105">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <Instagram className="text-frezza-red mr-3" size={24} />
                      <span className="text-frezza-red font-semibold">Influencer</span>
                    </div>
                    <h4 className="text-xl font-bold mb-2 text-white">Creator Digital</h4>
                    <p className="text-gray-400 mb-4 text-sm">Crescimento de 250K seguidores em 6 meses.</p>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-300">Crescimento:</span>
                      <span className="text-frezza-red font-bold">250K</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="group overflow-hidden border-white/10 bg-gradient-to-br from-zinc-900/50 to-black hover:from-frezza-red/10 hover:to-zinc-900/50 transition-all duration-500 hover:scale-105">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <BarChart className="text-frezza-red mr-3" size={24} />
                      <span className="text-frezza-red font-semibold">Fitness</span>
                    </div>
                    <h4 className="text-xl font-bold mb-2 text-white">Academia Premium</h4>
                    <p className="text-gray-400 mb-4 text-sm">Redução de 60% no custo por lead com estratégia otimizada.</p>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-300">Economia:</span>
                      <span className="text-frezza-red font-bold">-60%</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            {/* Portfólio Destacado */}
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-center mb-8 text-white">Trabalhos em Destaque</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {portfolioItems.slice(0, 6).map(item => renderPortfolioItem(item))}
              </div>
            </div>
            ...
            <div className="text-center mt-12">
              <Button 
                variant="outline" 
                size="lg" 
                className="border-frezza-red text-frezza-red hover:bg-frezza-red hover:text-white transition-all duration-300 px-8 py-6 text-lg"
