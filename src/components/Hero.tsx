      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-float hidden md:block">
            ...
            <div className="absolute -top-6 -right-6 bg-frezza-accent w-24 h-24 rounded-full opacity-20"></div>
            <div className="absolute -bottom-4 -left-4 bg-frezza w-16 h-16 rounded-full opacity-20"></div>
          </div>
        </div>
