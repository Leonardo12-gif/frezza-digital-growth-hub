...
export function ShaderAnimation() {
  ...
  useEffect(() => {
    ...
    // Updated fragment shader with red color palette
    const fragmentShader = `
      ...
      // Updated to red color palette for Frezza Marketing
      vec3 getColor(float intensity) {
          vec3 color1 = vec3(0.8, 0.0, 0.0);   // Dark Red
          vec3 color2 = vec3(1.0, 0.0, 0.0);   // Pure Red
          vec3 color3 = vec3(1.0, 0.2, 0.2);   // Light Red
          vec3 color4 = vec3(1.0, 0.4, 0.4);   // Pink Red
          vec3 color5 = vec3(1.0, 0.6, 0.6);   // Light Pink
          vec3 color6 = vec3(1.0, 0.8, 0.8);   // Very Light Pink
          vec3 color7 = vec3(1.0, 0.9, 0.9);   // Almost White Pink
